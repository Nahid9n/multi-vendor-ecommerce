...
@section('body')
            ...
            <div class="row">
                <div class="home_alls">
                    <ul>
                        ...
                        <li><a target="blank" href="product.html">All Products</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="product_all">
        <div class="container-fluid">
            <p style="font-size: 16px; font-weight: 700; line-height: 19px; color:#000000; margin-left: 26%; margin-bottom: 30px;">ALL PRODUCTS</p>
            <div class="row">
...
{{-- all product  --}}
                    <div class="row">
                        ...
                        @foreach($products as $product)
                            <div class="col-xl-2 my-2 col-lg-2 col-md-2 col-sm-6 colsm6">
                                <div class="card">
                                    <div class="card-header border-0 p-0 m-0 text-center">
                                        <a href="{{route('product.details',$product->slug)}}" target="blank">
                                            <img src="{{asset($product->product_image)}}" height="350" class="p-0 w-100" alt="a" />
                                        </a>
                                    </div>
                                    <div class="card-body">
