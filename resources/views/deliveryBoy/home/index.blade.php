            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-md-6 col-lg-3 my-1">
                    <div class="card bg-primary bg-opacity-75 info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="icn-box fa fa-money-bill text-dark fw-bold fs-13 me-1"></i>
                                </div>
                                <div class="ps-3">
                                    <h6  style="color: white;">{{$deliveryBoyDetail->earning ?? '0'}} .{{$currency->symbol ?? ''}}</h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-md-6 col-lg-3 my-1">
                    <div class="card bg-success bg-opacity-75 info-card sales-card">
                        <div class="card-body">
                            <h5 class="card-title" style="color: white;">Total Withdraw</h5>
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="icn-box fa fa-money-bill-transfer text-dark fw-bold fs-13 me-1"></i>
                                </div>
                                <div class="ps-3">
                                    <h6 style="color: white;">{{$deliveryBoyDetail->total_withdraw ?? '0'}} .{{$currency->symbol ?? ''}}</h6>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-md-6 col-lg-3 my-1">
                    <div class="card bg-info bg-opacity-75 info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="icn-box fa fa-money-bill-trend-up text-dark fw-bold fs-13 me-1"></i>
                                </div>
                                <div class="ps-3">
                ...
                <div class="col-xxl-4 col-md-6 col-lg-3 my-1">
                    <div class="card bg-success bg-opacity-75 info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="icn-box fa fa-clock text-dark fw-bold fs-13 me-1"></i>
                                </div>
                                <div class="ps-3">
                ...
                <div class="col-xxl-4 col-md-6 col-lg-3 my-1">
                    <div class="card bg-info bg-opacity-75 info-card sales-card">
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="card-icon rounded-circle d-flex align-items-center justify-content-center">
                                    <i class="icn-box fa fa-check-circle text-dark fw-bold fs-13 me-1"></i>
                                </div>
                                <div class="ps-3">
