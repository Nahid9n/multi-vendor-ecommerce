                    ...
                    <div class="card-body">
                        @if (session('message'))
                            <p class="alert alert-primary text-center" x-data="{ show: true }"
                                x-init="setTimeout(() => show = false, 4000)" x-show="show">{{ session('message') }}</p>
                        @endif
                        <form class="login100-form validate-form" action="{{ route('seller.login') }}"
                            method="post">
                            @csrf
                            ...
                            <div class="text-end pt-1">
                                <p class="mb-0"><a href="{{ route('seller.ForgotPasswordForm') }}"
                            ...
                            <div class="text-center pt-3">
                                <p class="text-dark mb-0">Not a member?<a
                                        href="{{ route('seller.registrationForm') }}"
