...
@include('modal.common')
    ...
    <div class="page-header">
        <div>
            <h1 class="page-title">Classified Package Module</h1>
        </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('classifiedPackage.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
