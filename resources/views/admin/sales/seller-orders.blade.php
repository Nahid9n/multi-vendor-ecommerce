                    ...
                    <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap text-center key-buttons border-bottom  w-100">
                            ...
                            @foreach($orders as $key => $order)
                                <tr>
                                    <td><a href="{{route('sales.seller.orders.show',$order->id)}}">{{$order->order_code}}</a></td>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{route('sales.seller.orders.show',$order->id)}}" class="btn btn-sm btn-success mx-1"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('admin.seller.order.invoice',$order->id)}}" class="btn btn-sm btn-primary mx-1"><i class="fa fa-info-circle"></i></a>
                                        <a class="btn btn-sm {{$order->delivery_status == 3 ? 'btn-secondary disabled':'btn-warning'}} mx-1" data-bs-target="#modalInput{{$key}}" data-bs-toggle="modal" href="javascript:void(0)"><i class="fa-solid fa-person-digging"></i></a>
