...
@section('body')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('sales.in-house-orders')}}">Inhouse Orders</a></li>
                ...
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        @endforeach
                            <tr class="text-center">
                                ...
                                <td class="text-dark">{{$sum}} .{{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="5" class="text-end">Shipping </td>
                                <td class="text-dark">{{$order->total_shipping}} .{{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="5" class="text-end">Tax </td>
                                <td class="text-dark">{{$tax}}.{{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="5" class="text-end bg-success-transparent text-dark">In Total </td>
                                <td colspan="6" class="bg-success-transparent">{{$sum+$order->total_shipping+$tax}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>{{$sum+$order->total_shipping+$tax}} {{$currency->symbol ?? ''}}</td>
                        </tr>
                        <tr>
                            <th>Payment Date</th>
