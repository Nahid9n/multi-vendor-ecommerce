...
@section('body')
    ...
    <div class="page-header">
        ...
        <div class="ms-auto pageheader-btn">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{route('sales.seller-orders')}}">Seller Order</a></li>
    ...
    <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="text-end">
                    <a href="{{route('sales.in-house-orders')}}" class="btn btn-success my-1 float-end mx-2 text-center">All In House Orders</a>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        @endforeach
                            ...
                            <tr class="text-center">
                                <td colspan="5" class="text-end bg-success-transparent text-dark">Total </td>
                                <td colspan="6" class="bg-success-transparent">{{$sum}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="5" class="text-end bg-success-transparent text-dark">Admin Commission ({{$sellerCommission->seller_commission}}%)</td>
                                <td colspan="6" class="bg-success-transparent">{{$commission = $sum * ($sellerCommission->seller_commission/100)}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="5" class="text-end bg-success-transparent text-dark">In Total</td>
                                <td colspan="6" class="bg-success-transparent">{{$sum - $commission}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                        </tbody>
                    </table>
                            ...
                            <td>
                                ...
                                <div class="my-3 d-flex">
                                    ...
                                    <form class="" action="{{route('admin.deliveryBoy.cancel.request.pickup',$order->id)}}" method="post">
                                        ...
                                        <button class="btn btn-sm btn-danger mx-1" >Cancel</button>
                                    </form>
                                </div>
                                @endif
                            </td>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tr>
                            <th>Order Status</th>
                            <td class="{{$order->order_status == 0 ? 'bg-warning':''}}{{$order->order_status == 1 ? 'bg-success':''}}{{$order->order_status == 2 ? 'bg-danger text-white':''}}">
