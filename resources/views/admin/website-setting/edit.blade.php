                                    ...
                                    <div class="position-relative d-flex" id="imageContainer">
                                        <div class="imgs m-1">
                                            @if($websiteSetting->logo != '')
                                                ...
                                                <img width="400" height="100" class="img" src="{{asset($websiteSetting->logo)}}" alt="">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="position-relative d-flex" id="imageContainer">
                                        <div class="imgs m-1">
                                            @if($websiteSetting->banner != '')
                                                <span class="btn btn-danger btn-sm position-absolute rmSingleimg" id="" style="float: left">&times;</span>
                                                <img width="400" height="100" class="img" src="{{asset($websiteSetting->banner)}}" alt="">
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="position-relative d-flex" id="imageContainer">
                                        <div class="imgs m-1">
                                            @if($websiteSetting->icon != '')
                                                <span class="btn btn-danger btn-sm position-absolute rmSingleimg" id="" style="float: left">&times;</span>
                                                <img width="400" height="100" class="img" src="{{asset($websiteSetting->icon)}}" alt="">
                                            @endif
                                        </div>
                                    </div>
                                </div>
