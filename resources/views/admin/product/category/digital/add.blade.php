        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom justify-content-between">
                    ...
                    <a href="{{ route('digitals.index') }}" class="btn btn-success my-1 float-end mx-2 text-center">All
                        Category</a>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('digitals.store') }}" method="post"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9 test_class">
                                ...
                                <b><span class="text-danger">{{$errors->first('cover')}}</span></b>
                            </div>
                        </div>
