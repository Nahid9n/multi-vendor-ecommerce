                        ...
                        <table id="example3" class="table table-bordered text-nowrap border-bottom">
                            ...
                            @foreach($deliveryBoys as $deliveryBoy)
                                <tr class="text-center">
                                    ...
                                    <td>{{$deliveryBoy->user->email}}</td>
                                    <td><span class="p-1 {{$deliveryBoy->status == 1 ? 'bg-success text-white':'bg-danger text-white'}}">{{$deliveryBoy->status == 1 ? 'active':'Banned'}}</span></td>
                                    ...
                                    <td class="text-center justify-content-center d-flex">
                                        ...
                                        <a href="{{route('delivery-boy.edit.info',$deliveryBoy->user_id)}}" class="btn btn-primary mb-1 mx-1">
