                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 chatbox">
                                                ...
                                                @foreach($conversation as $con)
                                                    ...
                                                    <p class="message_time {{ (auth()->user()->id == $con->sender_id)? "text-right" : "text-left" }}">{{date_format($con->created_at,'d M, Y h:m a')}}</p>
                                                @endforeach
                                               ...
                                               <form action="{{ route('send.message') }}" method="post">
                                                    ...
                                                    <input type="hidden" name="receiver_id" value="{{ $conversation[0]->receiver_id }}">
