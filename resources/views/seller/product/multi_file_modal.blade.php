<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <form action="{{ route('seller.file.save.selection.multiple') }}" method="POST" id="multiFileForm">
            @else
                <form action="{{ route('admin.file.save.selection.multiple') }}" method="POST" id="singleFileForm">
            @endif
            @csrf
