    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller.dashboard') }}">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('category-wise-discount.index') }}" class="slide-item">Category-Wise-Discount</a></li>
                        {{-- <li><a href="{{ route('digital-product.index') }}" class="slide-item">All Digital Product</a></li>
                        <li><a href="{{ route('digital-product.create') }}" class="slide-item">Add Digital Product</a></li> --}}
                        {{-- <li><a href="{{ route('seller-product.order') }}" class="slide-item">Product Orders</a></li> --}}
                    </ul>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('seller.order.manage') }}" class="slide-item">All Orders</a></li>
                        <li><a href="{{ route('seller.order.complete') }}" class="slide-item">Complete Orders</a></li>
                    </ul>
                </li>

                @endif
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller.shop-setting.index') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller-coupon.index') }}">
                ...
                {{-- <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        <i class="fa-solid fa-tags mx-3"></i>
                        <span class="side-menu__label">Packages</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li><a href="{{ route('seller-package-list') }}" class="slide-item">Packages</a></li>
                        <li><a href="{{route('seller.purchage.package')}}" class="slide-item">Purchage Packages</a></li>

                    </ul>
                </li> --}}
                @if (auth()->user()->status == 1)
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller.payment.info') }}">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        {{-- <li><a href="{{route('seller.ticket.manage')}}" class="slide-item">Tickets</a></li> --}}
                        {{-- <li><a href="{{route('product.conversation')}}" class="slide-item">Product conversion</a></li> --}}
                        <li><a href="{{route('seller.product.queries')}}" class="slide-item">Product Queries</a></li>
                    </ul>
                </li>
                @endif
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller.file.manage') }}">
                ...
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('seller.wallet') }}">
                ...
                <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li><a href="{{ route('seller.profile') }}" class="slide-item">Profile</a></li>
                        <li><a href="{{route('seller.logout')}}" class="slide-item">Logout</a></li>
                    </ul>
                </li>
                @endif
            </ul>
