...
<body class="ltr app sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--APP-SIDEBAR-->
            @include('seller.Layout.side-bar')
            <!--/APP-SIDEBAR-->
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates"
                                            src="{{ asset('/') }}seller/assets/images/flags/us_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy"
                                            src="{{ asset('/') }}seller/assets/images/flags/italy_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="spain"
                                            src="{{ asset('/') }}seller/assets/images/flags/spain_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="india"
                                            src="{{ asset('/') }}seller/assets/images/flags/india_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="french"
                                            src="{{ asset('/') }}seller/assets/images/flags/french_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="russia"
                                            src="{{ asset('/') }}seller/assets/images/flags/russia_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="germany"
                                            src="{{ asset('/') }}seller/assets/images/flags/germany_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina"
                                            src="{{ asset('/') }}seller/assets/images/flags/argentina_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae"
                                            src="{{ asset('/') }}seller/assets/images/flags/uae_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria"
                                            src="{{ asset('/') }}seller/assets/images/flags/austria_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico"
                                            src="{{ asset('/') }}seller/assets/images/flags/mexico_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china"
                                            src="{{ asset('/') }}seller/assets/images/flags/china_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland"
                                            src="{{ asset('/') }}seller/assets/images/flags/poland_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada"
                                            src="{{ asset('/') }}seller/assets/images/flags/canada_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia"
                                            src="{{ asset('/') }}seller/assets/images/flags/malaysia_flag.jpg"
                                ...
                                <div class="m-0 wp-70 text-dark d-flex align-items-center">
                                    <div class="me-2">
                                        <img alt="User Avatar" class="rounded-circle avatar-sm"
                                            src="{{ asset('/') }}seller/assets/images/users/7.jpg">
                                    </div>
                                    <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}seller/assets/images/users/8.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}seller/assets/images/users/2.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="{{ asset('/') }}seller/assets/images/users/11.jpg">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-lg"
                                                                src="{{ asset('/') }}seller/assets/images/users/14.jpg">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="media mb-5 overflow-visible">
                                            <div class="me-3">
                                                <a href="profile.html"> <img
                                                        ...
                                                        src="{{ asset('/') }}seller/assets/images/users/5.jpg">
                                                </a>
                                            </div>
    ...
    <script>
        $(document).on('click','.openImageModal', function(e) {
            ...
            if(multiple === true){
                var url ="{{ route('sellerMultipleSection') }}";
            }else{
                var url ="{{ route('sellerSingleSelection') }}";
            }
            $.ajax({
                url: url,
                type: 'GET',
    ...
    <script>
        ...
        {{-- Live search file upload modal section --}}
        $(document).ready(function() {
