                            ...
                            <div class="d-flex flex-wrap align-items-center">
                                <div class="profile-img-main rounded">
                                    @if(auth()->user()->image !=null)
                                        <img  width="80" height="80" src="{{ asset(auth()->user()->image) }}" alt="" class="m-0 rounded border border-3">
                                    @endif
                                    @if (auth()->user()->image == null)
                                        <img width="80" height="80" src="{{ asset('avatar/avatar.png') }}" alt="" class="m-0 rounded border border-3">
                                    @endif
                                </div>
                                <div class="ms-4">
                                                ...
                                                <div class="position-relative d-flex" id="imageContainer">
                                                    <div class="imgs m-1">
                                                        @if(auth()->user()->image != '')
                                                            ...
                                                            <img width="250" height="150" class="img" src="{{asset(auth()->user()->image)}}" alt="">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
