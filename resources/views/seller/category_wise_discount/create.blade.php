    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('category-wise-discount.store') }}" method="post" >
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ old('discount') }}" name="discount" id="" placeholder="Number" type="number" min="0" required/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            ...
                            <input class="form-control" value="{{ old('datefilter') }}" name="datefilter" id=""type="text" placeholder="Select Date" required/>
                    ...
                    <div class="row mb-4 d-flex form-group">
                        ...
                        <div class="col-md-9">
                            <div class="material-switch">
                                <input id="feature_product" value="1" name="status" {{ old('featured_status') ? 'checked' : '' }} type="checkbox"/>
