                ...
                <div class="m-3">
                    <div class="row">
                        <div class="card-header border-bottom justify-content-between">
                            ...
                            <a href="{{route('seller.file.upload')}}" class="btn btn-primary my-1 text-center">Upload New File</a>
                        </div>
                    </div>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    function getFilteredData(sort = null, page = 1) {
        var sortItemUrl = "{{ route('seller.file.sort.item') }}";
        $.ajax({
            type: 'GET',
            url: sortItemUrl,
            dataType: "html",
