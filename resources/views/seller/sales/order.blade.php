...
{{--                                    <td>{{$order->user->user->name}}</td>--}}
                                    ...
                                    <td>
                                        <span class="{{$order->order_status == 0 ? 'bg-warning':''}}{{$order->order_status == 1 ? 'bg-success':''}}{{$order->order_status == 2 ? 'bg-danger text-white':''}}{{$order->order_status == 3 ? 'bg-primary':''}} p-1 rounded-3">
