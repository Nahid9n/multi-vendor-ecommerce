                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        @endforeach
                            <tr class="text-center">
                                ...
                                <td colspan="5" class="bg-success-transparent">{{number_format($sum,2)}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="4" class="text-end bg-success-transparent text-dark">Admin Commission ({{$sellerCommission->seller_commission}}%)</td>
                                <td colspan="5" class="bg-success-transparent">{{$commission = number_format($sum * ($sellerCommission->seller_commission/100),2)}} {{$currency->symbol ?? ''}}</td>
                            </tr>
                            <tr class="text-center">
                                <td colspan="4" class="text-end bg-success-transparent text-dark">In Total</td>
                                <td colspan="5" class="bg-success-transparent">{{number_format($sum - $commission,2)}} {{$currency->symbol ?? ''}}</td>
                            </tr>
