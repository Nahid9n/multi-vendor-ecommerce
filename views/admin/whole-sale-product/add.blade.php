    ...
    <div class="col">
        <div class="card">
            <div class="card-header border-bottom justify-content-between">
                <h3 class="card-title text-bold">Add New Whole Sale Product</h3>
                <a href="{{route('whole-sale-product.index')}}" class="btn btn-primary my-1 mx-2 text-center">All Product</a>
            </div>
            <div class="card-body">
                <form class="" action="{{ route('whole-sale-product.store') }}" method="post" enctype="multipart/form-data" id="choice_form">
                    @csrf
                    <input type="hidden" name="product_type" value="whole-sale-product" required>
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        <label for=""  class="col-md-3 form-label">Unit Name <span class="text-danger">*</span></label>
                        <div class="col-md-9 form-group">
                            <select name="unit_id"  class="form-control select2 select2-show-search" data-placeholder="Select Unit" >
                                <option value="" disabled selected> -- Select Brand --</option>
                    ...
                    <div class="row mb-4">
                        <label for=""  class="col-md-3 form-label">Unit Amount <span class="text-danger">*</span></label>
                        <div class="col-md-9">
                            <input class="form-control" value="{{ old('unit_amount') }}" name="unit_amount" id="" placeholder="Unit Amount" type="text"/>
                    ...
                    <div class="row mb-4" id="product_stock">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="1" name="product_stock" id="product_stock_change" placeholder="1" min="1" type="number"/>

                        </div>
                    </div>
                    <div class="row mb-4" id="prodcut_image">
                        <label for="" class="col-md-3 form-label">Product Image <span class="text-danger">*</span></label>
                        <div class="col-md-9 test_class">
                            ...
                            <input type="hidden" id="product_imageItemId" name="product_image" required>
                    ...
                    <div class="row mb-4">
                        <label for="" class="col-md-3 form-label" >Other Images <span class="text-danger">*</span></label>
                        <div class="col-md-9 test_class">
                            ...
                            <input type="hidden" id="other_imagesItemId" name="images" required>
