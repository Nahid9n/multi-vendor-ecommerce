                    ...
                    <form action="{{ route('products.update') }}" method="post" enctype="multipart/form-data"
                                ...
                                <select name="category_id" class="form-control select2 select2-show-search form-select"
                                    ...
                                    @forelse($parent_categories as $parent_category)
                                        ...
                                        <option value="{{ $parent_category->id }}"
                                            {{ $parent_category->id == $product->category_id }}
                        ...
                        <div class="row mb-4" id="product_price">
                            <label for="" class="col-md-3 form-label"> Product Price<span
                                    class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input class="form-control" value="{{ $product->product_price }}" name="product_price"
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9 form-group">
                                    <input type="hidden" class="form-control" name="product_select"
                                        value="{{ $product->product_select }}" readonly>
                                    <select name="product_select"
                                        class="form-control select2 select2-show-search form-select"
                                        data-placeholder="Select Product" onchange="productSelect(this)" disabled>
                                        <option value="single_product"
                                            @if ($product->product_select == 'single_product') @selected(true) @endif>Single
                                            Product</option>
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-md-9 form-group">
                                    <select name="choice_attributes[]" id="choice_attributes"
                                        class="form-control color_multiple select2 select2-show-search" multiple
                        ...
                        <div class="row mb-4 d-flex form-group">
                            ...
                            <div class="col-md-9">
                                <div class="material-switch">
                                    <input id="status" value="1" {{ $product->status == 1 ? 'checked' : '' }}
