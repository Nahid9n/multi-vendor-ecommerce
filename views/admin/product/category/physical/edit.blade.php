        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header border-bottom justify-content-between">
                    ...
                    <a href="{{ route('physicals.index') }}" class="btn btn-success my-1 mx-2 text-center">All Category</a>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('physicals.update', $category->id) }}" method="post"
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <b><span class="text-danger">{{$errors->has('name') ? $errors->first('name'):''}}</span></b>
                            </div>
                        </div>
                        <div class="row mb-4 d-flex form-group">
                            ...
                            <div class="col-md-9">
                                <select class="form-control form-select" name="parent_id" data-placeholder="Choose one" required>
                        ...
                        {{-- <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <b><span class="text-danger">{{$errors->has('orderNumber') ? $errors->first('orderNumber'):''}}</span></b>
                            </div>
                        </div> --}}
