    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{route('sellerPackage.update',$package->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            <label for="" class="col-md-3 form-label">Package Logo</label>
                            <div class="col-md-9 test_class">
                                <div class="input-group singleFile" data-bs-toggle="modal" id="package_logo"
                                     data-bs-target="#singleImg" data-type="image" data-multiple="false">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">Browse</div>
                                    </div>
                                    <div class="form-control package_logoFile-amount" id="package_logoFileAmount">Choose file</div>
                                </div>
                                <input type="hidden" id="package_logoItemId" name="package_logo" readonly>
                                <div class="row d-flex singleRemove" id="package_logoData">
                                    <div class="position-relative d-flex" id="imageContainer">
                                        <div class="imgs m-1">
                                            @if($package->package_logo != '')
                                                <span class="btn btn-danger btn-sm position-absolute rmSingleimg" id="{{$package_logo->id ?? ''}}" style="float: left">&times;</span>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" required value="{{$package->duration}}" id="duration" name="duration" placeholder="Enter Package Duration" type="number">
