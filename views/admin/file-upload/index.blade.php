            ...
            <div class="m-3">
                <div class="row">
                    <div class="card-header border-bottom justify-content-between">
                        ...
                        <a href="{{route('seller.file.upload')}}" class="btn btn-primary my-1 text-center">Upload New
                            File</a>
                        @else
                        <a href="{{route('admin.file.upload')}}" class="btn btn-primary my-1 text-center">Upload New
                            File</a>
                        @endif
                    </div>
                </div>
