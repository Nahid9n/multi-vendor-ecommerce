            ...
            <div class="card-body">
                <form class="" action="{{ route('digital-product.update',$product->id) }}" method="post" enctype="multipart/form-data" id="choice_form">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="text" id="" value="{{ $product->name }}" name="name" placeholder="Product name"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ $product->bar_code }}" name="bar_code" id="bar_code" placeholder="Bar code" type="text"/>
                    ...
                    <div class="row mb-4" id="product_price">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ $product->product_price }}" name="product_price" id="product_price_change" placeholder="0.01" step=".01" min="0" type="number"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" id="shipping_cost" min="0" step=".01" name="shipping_cost" value="{{ $product->shipping_cost }}" placeholder="0.01" type="number"/>
