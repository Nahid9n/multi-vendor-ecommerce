@forelse($files as $file)
    <div class="card col-md-2">
        <div class="card-header my-2">
            <input class="form-check-input item-checkbox singleChecked singleChecked2 singleChecked3 multipleChecked multipleChecked2 multipleChecked3 btn-checkbox checked_btn" value="{{$file->id}}" type="checkbox">
            <div class="dropdown-file btn-lg">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0)" class="dropdown-item confirm-delete" data-href="">
                            <form action="{{route('seller.file.delete',$file->id)}}" method="POST">
                                @csrf
                                @method('delete')
