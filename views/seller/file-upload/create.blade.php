        ...
        <div class="col">
            <div class="card">
                <div class="card-header border-bottom justify-content-between">
                    ...
                    <a href="{{route('seller.file.manage')}}" class="btn btn-primary my-1 mx-2 text-center">All Uploads</a>

                </div>
                <div class="card-body text-center">
                        <form action="{{ route('seller.file.store') }}" class="dropzone" id="myDropzone" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-4">
                            <div class="col-md-12">
