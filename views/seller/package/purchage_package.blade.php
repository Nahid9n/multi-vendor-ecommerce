                    ...
                    <table id="" class="table table-bordered text-nowrap border-bottom">
                        ...
                        <tbody>
                            @php
                                $id=0;
                            @endphp
                            @foreach ($puchage_packages as $purchage_package)
                                <tr>
                                    <td>{{ ++$id }}</td>
                                    <td>{{ $purchage_package->package ??'N/A'}}</td>
                                    <td>{{ $purchage_package->package_price ??'N/A'}}</td>
                                    <td>{{ $purchage_package->payment_type ??'N/A' }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
