        ...
        <div class="col-lg-12 shadow">
            <div class="card">
                <div class="card-header justify-content-between border-bottom">
                    <h3 class="text-bold">Add Coupon Form</h3>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="row mb-4 d-flex form-group">
                                ...
                                <div class="col-md-9">
                                    <select class="form-control select2 select2-show-search form-select"
                                        ...
                                        <option class="form-control" label="Choose one" disabled selected>Select Product</option>
                            ...
                            <div class="row mb-4">
                                <label for="date" class="col-md-3 form-label">Date<span
                                        class="text-danger">*</span></label>
                                <div class="col-md-9">
                                    <input class="form-control" value="{{ old('daterange') }}" type="text" name="daterange"
                                         id="date" required>
