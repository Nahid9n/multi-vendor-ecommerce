...
<div class="row mt-5">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form class="" action="{{ route('category-wise-discount.store') }}" method="post" >
                    @csrf
                    <div class="row mb-4">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ old('discount') }}" name="discount" id="" placeholder="Number" type="number" min="0"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ old('datefilter') }}" name="datefilter" id=""type="text" placeholder="Select Date"/>
