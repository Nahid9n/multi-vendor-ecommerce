            ...
            <div class="card-body">
                <form class="" action="{{ route('category-wise-discount.update',$discount) }}" method="post" >
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{ $discount->discount }}" name="discount" id="" placeholder="Number" type="number" min="0"/>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" value="{{$discount->discount_date_range}}" name="datefilter" id=""type="text" placeholder="Select Date"/>
