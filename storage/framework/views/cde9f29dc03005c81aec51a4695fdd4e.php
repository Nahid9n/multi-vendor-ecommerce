    ...
    <div class="col">
        <div class="card">
            <div class="card-header row border-bottom">
                ...
                <div class="col-6">
                    <a href="<?php echo e(route('products.index')); ?>" class="btn btn-success my-1 float-end mx-2 text-center">All Product</a>
                    <a href="<?php echo e(route('products.edit', $product->id)); ?>" class="btn btn-warning my-1 float-end mx-2 text-center">Edit</a>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if($product->user_id == 1): ?>
                                <tr>
                                    <th>Seller Name</th>
                                    <td><?php echo e($product->user->name ?? "N/A"); ?></td>
                                </tr>
                            <?php else: ?>
                                <tr>
                                    <th>Shop Name</th>
                                    <td><?php echo e($product->user->seller->shop_name ?? "N/A"); ?></td>
                                </tr>
                            <?php endif; ?>
                            <tr>
                                <th>Product Name</th>
                            ...
                            <?php if($product->product_select == 'product_variant'): ?>

                            <?php if(isset($product->product_stock) > 0): ?>
                            <tr>
                                <th> Product Stock</th>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\NAHID\seo_multivendor_ecommerce\resources\views/admin/product/product_all/product-details.blade.php ENDPATH**/ ?>