    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-xl-10 col-lg-9 col-7">
                <?php if($_GET['keyword'] != null): ?>
                <h5>Search result for"<?= (isset($_GET['keyword'])) ? $_GET['keyword'] : '' ?>"</h5>
                <?php endif; ?>
                <div class="row" style="margin-bottom: 20px;">
                    <div class="items itemss">
                        <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="col-xl-3 my-2 col-lg-4 col-md-6 col-sm-12 colsm6 cart_item" title="<?php echo e($loop->iteration); ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="ratings d-flex justify-content-end hidden-sm">
                                        ...
                                        <?php if($product->product_select == 'single_product'): ?>
                                            <button onclick="productModalSingleProduct(<?php echo e($product->id); ?>)" class="productModal" id="<?php echo e($product->id); ?>" href="javascript:void(0)" class="navbar-brand mx-2"><i class="price-text-color fa fa-2x fa-shopping-cart"></i></button>
                                        <?php else: ?>
                                            <button onclick="productModal(<?php echo e($product->id); ?>)" class="productModal" id="<?php echo e($product->id); ?>" href="javascript:void(0)" class="navbar-brand mx-2"><i class="price-text-color fa fa-2x fa-shopping-cart"></i></button>
                                        <?php endif; ?>
                                        </abbr>
                                        <abbr title="Add to Wishlist">
                                            <?php if($product->product_select == 'single_product'): ?>
                                                <a class="addToWish navbar-brand mx-2" href="<?php echo e(route('add-to-wishlist', $product->id )); ?>"><i class="price-text-color fa fa-1x fa-heart"></i></a>
                                            <?php else: ?>
                                                <button onclick="productModalWish(<?php echo e($product->id); ?>)" class="productModal navbar-brand mx-2" id="<?php echo e($product->id); ?>" href="javascript:void(0)"><i class="price-text-color fa fa-1x fa-heart"></i></button>
                                            <?php endif; ?>
                                        </abbr> -->
                                    </div>
...
<?php echo $__env->make('website.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/website/home/search.blade.php ENDPATH**/ ?>