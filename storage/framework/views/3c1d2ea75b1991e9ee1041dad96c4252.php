...
<head>
    ...
    <?php echo $__env->make('seller.Layout.meta', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- TITLE -->
    <title>Ecom - <?php echo $__env->yieldContent('title'); ?></title>

    <?php echo $__env->make('seller.Layout.style', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body class="ltr app sidebar-mini">
    ...
    <div class="page">
        <div class="page-main">
            ...
            <!--APP-SIDEBAR-->
            <?php echo $__env->make('seller.Layout.side-bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <!--/APP-SIDEBAR-->
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block active">
                                    <span class="country-selector"><img alt="unitedstates"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/us_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="italy"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/italy_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="spain"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/spain_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="india"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/india_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="french"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/french_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="russia"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/russia_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="germany"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/germany_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="argentina"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/argentina_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="uae"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/uae_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="austria"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/austria_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="mexico"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/mexico_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="china"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/china_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="poland"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/poland_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="canada"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/canada_flag.jpg"
                            ...
                            <li class="col-lg-4 mb-2">
                                <a class="btn btn-country btn-lg btn-block">
                                    <span class="country-selector"><img alt="malaysia"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/flags/malaysia_flag.jpg"
                                ...
                                <div class="m-0 wp-70 text-dark d-flex align-items-center">
                                    <div class="me-2">
                                        <img alt="User Avatar" class="rounded-circle avatar-sm"
                                            src="<?php echo e(asset('/')); ?>seller/assets/images/users/7.jpg">
                                    </div>
                                    <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="<?php echo e(asset('/')); ?>seller/assets/images/users/8.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="<?php echo e(asset('/')); ?>seller/assets/images/users/2.jpg">
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-md"
                                                                src="<?php echo e(asset('/')); ?>seller/assets/images/users/11.jpg">
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="me-2">
                                                            <img alt="User Avatar" class="rounded-circle avatar-lg"
                                                                src="<?php echo e(asset('/')); ?>seller/assets/images/users/14.jpg">
                                                        </div>
                                                        <div>
                                        ...
                                        <div class="media mb-5 overflow-visible">
                                            <div class="me-3">
                                                <a href="profile.html"> <img
                                                        ...
                                                        src="<?php echo e(asset('/')); ?>seller/assets/images/users/5.jpg">
                                                </a>
                                            </div>
        ...
        $(document).ready(function() {
            $('#payment_type').on('change', function() {
                ...
                if (this.value == 'online_payment') {
                    ...
                    $('#OfflinePayment').modal('hide');
                    $('#onlinePayment').modal('show');
                }

                if (this.value == 'offline_payment') {
                    $('#exampleModal').modal('hide');
                    $('#onlinePayment').modal('hide');
                    $('#OfflinePayment').modal('show');
                    $("#OfflinePayment").find('#package_id').val();
                }
            });
        });

        function package_selection(data) {
    ...
    <script>
        ...
        function clicK_function(data) {
            var dynamicId = data.id;
            var targetModal = data.data('target');
            console.log(data, targetModal);
            $('#singleImg').data('dynamicId', dynamicId).show();
        }
        ...
        $(document).ready(function() {
            $(".rmSingleimg").on("click", function() {
                alert("Button clicked!");
            });
            $('.rmSingleimg').click(function() {
                var div = $(this);
                console.log(div, 'ttttttttttttt');
            });
        });

        function dataPagination(page) {
            $.ajax({
                url: "<?php echo e(route('paginate')); ?>",
                type: 'GET',
                data: {
                    page: page
                },
...
<?php /**PATH D:\NAHID\seo_multivendor_ecommerce\resources\views/seller/Layout/master.blade.php ENDPATH**/ ?>