...
<div class="row mt-5">
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <form class="" action="<?php echo e(route('product.store')); ?>" method="post" enctype="multipart/form-data"
                    id="choice_form">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('seller.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\NAHID\seo_multivendor_ecommerce\resources\views/seller/product/create.blade.php ENDPATH**/ ?>