<div class="modal-dialog modal-xl">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <form action="<?php echo e(route('seller.file.save.selection.multiple')); ?>" method="POST" id="multiFileForm">
            <?php else: ?>
                <form action="<?php echo e(route('admin.file.save.selection.multiple')); ?>" method="POST" id="singleFileForm">
            <?php endif; ?>
            <?php echo csrf_field(); ?>
            <div class="modal-body">
                ...
                <div class="card col-md-2">
                    <div class="card-header my-2">
                        <input class="form-check-input item-checkbox btn-checkbox" name="image_id[]" value="<?php echo e($file->id); ?>"
                            type="checkbox">
...
<?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/seller/product/multi_file_modal.blade.php ENDPATH**/ ?>