                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent-4">
                        <div class="d-flex order-lg-2">
                            <div class="dropdown d-flex profile-1">
                                <span class="mt-3"><?php echo e(auth()->user()->name); ?></span>
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        <img src="<?php echo e(asset('/')); ?>admin/assets/images/faces/6.jpg" alt="profile-user" class="avatar  profile-user brround cover-image">
                                    </span>
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                   ...
                                   <a class="dropdown-item" href="<?php echo e(route('website-settings.show',$website_setting->id)); ?>">
...
<?php /**PATH F:\Project\Seo Mutlivendor Home\seo_multivendor_ecommerce\resources\views/admin/Layout/header.blade.php ENDPATH**/ ?>