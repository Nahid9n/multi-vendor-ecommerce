<div class="modal fade bd-example-modal-xl multipleFile" id="multipleImg" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="false">
    <div class="modal-dialog modal-dialog modal-xl" role="document">
        <div class="modal-content modal-dialog-scrollable">
                    ...
                    <div class="row mt-5 justify-content-center">
                        <div class="card p-0">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <label for="selectAll" class="btn btn-success" id="selectAllbuttonmul">Select All</label>
                                        <label for="" class="btn btn-success resetButton">Reset</label>
                                ...
                                <div class="row ajax_data" id="ajax_datamul">
            ...
            <div class="modal-footer fixed-bottom ">
                ...
                <button type="button" id="mulitpleSaveSelection" class="btn btn-primary">Apply</button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH F:\Project\Seo Mutlivendor Home\seo_multivendor_ecommerce\resources\views/admin/Layout/modals/exampleModalScrollable2.blade.php ENDPATH**/ ?>