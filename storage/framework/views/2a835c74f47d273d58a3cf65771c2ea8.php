            ...
            <tr class="variant">
                ...
                <td>
                    <input type="number" lang="en" name="price_<?php echo e($str); ?>" value="<?php
                           ...
                           ?>" min="1" step="1" class="form-control" placeholder="1" required>
                </td>
                <td>
							...
							<div class="position-relative d-flex">
                                    <div class="imgs m-1">
                                        <?php if(isset($product->product_image)): ?>
                                            ...
                                            <img width="100" height="100" class="img" src="<?php echo e(asset($stock->image)); ?>" alt="">
                                        <?php endif; ?>
                                    </div>
                                </div>
						</div>
...
<?php endif; ?>
<?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/admin/product/product_all/sku_combinations_edit.blade.php ENDPATH**/ ?>