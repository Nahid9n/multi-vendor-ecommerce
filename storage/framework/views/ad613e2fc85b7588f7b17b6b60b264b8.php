                ...
                <div class="m-3">
                    <div class="row">
                        <div class="card-header border-bottom justify-content-between">
                            ...
                            <a href="<?php echo e(route('seller.file.upload')); ?>" class="btn btn-primary my-1 text-center">Upload New File</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                                <div class="row p-3 ">
                                    ...
                                    <div class="col-md-3 ml-auto mr-0 mb-2">
                                        <form>
                                            <select class="form-control form-control-xs aiz-selectpicker filterUploadFile" name="sort">
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-12 mb-2">
                                            <form>
                                                <input type="text" class="form-control searchTerm form-control-xs" name="search" id="searchValue"  placeholder="Search your files" value="">
                                            </form>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    function getAllFiles(page = 1) {
        $.ajax({
            type: 'GET',
            url: "<?php echo e(route('seller.file.items')); ?>",
            dataType: 'html',
            data: {
                page: page
            },
    ...
    function getFilteredData(sort = null, page = 1) {
        var sortItemUrl = "<?php echo e(route('seller.file.sort.item')); ?>";
        $.ajax({
            type: 'GET',
            url: sortItemUrl,
            dataType: "html",
    ...
    $(document).on('keyup', '#searchValue', function(event) {
        ...
        if (searchTerm.length >= 1) {
            $.ajax({
                url: "<?php echo e(route('seller.file.search')); ?>",
                type: 'GET',
                data: {
                    search: searchTerm
                },
...
<?php echo $__env->make('seller.Layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\NAHID\seo_multivendor_ecommerce\resources\views/seller/file-upload/index.blade.php ENDPATH**/ ?>