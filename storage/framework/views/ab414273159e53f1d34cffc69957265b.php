        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-header border-bottom justify-content-between">
                    <h3 class="card-title text-bold">Sellers Orders Table</h3>
                </div>
                    ...
                    <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap text-center key-buttons border-bottom  w-100">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><a href="<?php echo e(route('sales.seller.orders.show',$order->id)); ?>"><?php echo e($order->order_code); ?></a></td>
                                    ...
                                    <td class="d-flex">
                                        <a href="<?php echo e(route('sales.seller.orders.show',$order->id)); ?>" class="btn btn-sm btn-success mx-1"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo e(route('admin.seller.order.invoice',$order->id)); ?>" class="btn btn-sm btn-primary mx-1"><i class="fa fa-info-circle"></i></a>
                                        <a class="btn btn-sm <?php echo e($order->delivery_status == 3 ? 'btn-secondary disabled':'btn-warning'); ?> mx-1" data-bs-target="#modalInput<?php echo e($key); ?>" data-bs-toggle="modal" href="javascript:void(0)"><i class="fa-solid fa-person-digging"></i></a>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/admin/sales/seller-orders.blade.php ENDPATH**/ ?>