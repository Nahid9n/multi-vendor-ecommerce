    ...
    <div class="row mt-5">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('products.update')); ?>" method="post" enctype="multipart/form-data"
                        id="choice_form">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/admin/product/product_all/edit.blade.php ENDPATH**/ ?>