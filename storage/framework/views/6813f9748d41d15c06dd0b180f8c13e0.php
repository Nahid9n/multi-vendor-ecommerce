                    ...
                    <div class="table-responsive export-table">
                        <table id="file-datatable" class="table table-bordered text-nowrap text-center key-buttons border-bottom  w-100">
                            ...
                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><a href="<?php echo e(route('sales.in.house.orders.show',$order->id)); ?>"><?php echo e($order->order_code); ?></a></td>
                                    ...
                                    <td class="d-flex">
                                        <a href="<?php echo e(route('sales.in.house.orders.show',$order->id)); ?>" class="btn btn-sm btn-success mx-1"><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo e(route('admin.order.invoice.in.house',$order->id)); ?>" class="btn btn-sm btn-primary mx-1"><i class="fa fa-info-circle"></i></a>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Project\seo_multivendor_ecommerce\resources\views/admin/sales/in-house-orders.blade.php ENDPATH**/ ?>